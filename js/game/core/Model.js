...
var KAIOPUA = (function (main) {
    ...
    function instantiate ( parameters ) {
		...
		if ( parameters.hasOwnProperty( 'targetable' ) ) {
			...
			m.targetable = parameters.targetable;
		...
		if ( parameters.hasOwnProperty( 'interactive' ) ) {
			...
			m.interactive = parameters.interactive;
		...
		if ( parameters.hasOwnProperty( 'rigidBody' ) ) {
			...
			m.rigidBody = parameters.rigidBody;
			
		}
		else if ( parameters.hasOwnProperty( 'rigidBodyInfo' ) ) {
				
			m.rigidBody = physics.translate( m.mesh, parameters.rigidBodyInfo );
    ...
    function parse_morph_name( name ) {
        var mathhelper = game.workers.mathhelper,
			nameParsed = { 
                name: name,
                number: 0
            },
