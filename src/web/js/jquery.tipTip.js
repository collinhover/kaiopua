...
(function($){
	$.fn.tipTip = function(options) {
		...
		opts.edgeOffset = opts.edgeOffset || defaults.edgeOffset;
		opts.defaultPosition = opts.defaultPosition || defaults.defaultPosition;
		opts.delay = opts.delay || defaults.delay;
		opts.fadeIn = opts.fadeIn || defaults.fadeIn;
		opts.fadeOut = opts.fadeOut || defaults.fadeOut;
		opts.attribute = opts.attribute || defaults.attribute;
		opts.content = opts.content || defaults.content;
		opts.enter = opts.enter || defaults.enter;
		opts.exit = opts.exit || defaults.exit;
		opts.click = opts.click || defaults.click;
