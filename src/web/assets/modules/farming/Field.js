...
(function (main) {
	...
	function init_internal ( pzl, dirt, msg, mh ) {
		...
		_Field.Instance.prototype.reset = reset;
		_Field.Instance.prototype.complete = complete;
	...
	function complete() {
		...
		_Field.Instance.prototype.supr.complete.call( this );
		
		// if is completed
		
		if ( this.completedPerfect !== true && this.completed === true ){
			...
			if ( numElementsToMin > 0 ) {
				...
				scoreHTML += "<li class='grid_compartment score_counter'><div class='grid_cell_inner'><p class='score_label'>you completed it with only</p><p class='score_count text_huge score_count_highlight'>" + numElementsUsed + "</p><p class='score_label'>plants</p></div></li>";
	...
	function reset() {
		...
		_Field.Instance.prototype.supr.reset.call( this );
		
		// properties
		
		this.completedPerfect = false;
